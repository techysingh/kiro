...
declare -x OVPN_EXTRA_SERVER_CONFIG=([0]="duplicate-cn" [1]="topology subnet")
...
declare -x OVPN_PUSH=([0]="route 172.16.1.0 255.255.255.0")
declare -x OVPN_ROUTES=([0]="192.168.254.0/24")
declare -x OVPN_SERVER=192.168.255.0/24
declare -x OVPN_SERVER_URL=udp://68.5.31.2
